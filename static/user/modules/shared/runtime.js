...
export function mapPrintErrorMessage(errorCode, message) {
  ...
  const safeMessages = {
    ...
    printer_unavailable: "打印机正在处理上一项任务，请稍候再试。",
    printer_capability_unsupported: "打印机不支持当前打印参数，请调整后重试。",
    print_quota_insufficient: "当前打印额度不足，请联系管理员增加额度。",
    terminal_session_invalid: "终端会话已失效，请返回二维码页面重新登录。",
    site_portal_mismatch: "当前登录入口与终端会话不一致，请重新登录。",
    print_confirmation_conflict: "本次打印确认内容已变化，请重新选择文件。",
    job_bind_failed: "打印任务绑定失败，请重新选择文件后重试。",
    print_authorization_failed: "打印授权失败，请联系管理员。",
    print_authorization_denied: "打印授权未通过，请联系管理员。",
    user_disabled: "当前用户已被停用，无法打印。",
